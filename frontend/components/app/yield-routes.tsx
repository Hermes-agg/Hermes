    ...
    <div className="rounded-2xl border border-border/50 bg-card/80 backdrop-blur-sm">
      ...
      <div className="divide-y divide-border/50">
        {filteredRoutes.map((route, index) => (
          <div
            key={route.id}
            className={cn("p-3 sm:p-4 transition-all hover:bg-secondary/30", index === 0 && "bg-primary/5")}
          >
            {/* Mobile layout */}
            <div className="flex flex-col gap-3 sm:hidden">
              <div className="flex items-start justify-between gap-2">
                <div className="flex items-center gap-2 min-w-0">
                  <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-secondary text-xs font-bold text-foreground">
              ...
              <div className="grid grid-cols-3 gap-1.5 sm:gap-2 rounded-xl bg-secondary/50 text-xs sm:text-sm">
                ...
                <div className="flex flex-col gap-2 w-full">
                  <div className="min-w-0 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-secondary text-sm font-bold text-foreground">
                        {route.protocol.charAt(0)}
                      </div>
